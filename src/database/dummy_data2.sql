...
-- dummy battery model
INSERT INTO goboatv2.battery_models (model_ID,model_name,max_voltage,voltage_schema,battery_type)
VALUES ('lit_m1','litiumion model 1','12','volt_skema','LitiumIon');


-- Dummy batteriries for the boats
INSERT INTO goboatv2.batteries 	(bat_ID,First_used,model_ID)
VALUES 
...
INSERT INTO goboatv2.boats (boat_ID,total_slots)
VALUES 
('boat1',8),
('boat2',8),
('boat3',8),
...
INSERT INTO goboatv2.boat_conf (bat_ID,boat_ID,slot_no)
VALUES
('bat11','boat1',1),
('bat12','boat1',2),
('bat13','boat1',3),
